...
export default function BlogSection() {
  ...
  return (
    <>
      ...
      <section
        id="blog"
        className="py-16 sm:py-20 bg-[#f7fbd1] overflow-hidden"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex gap-2 justify-start w-max">
              {TABS.map((tab) => (
                <button
                  ...
                  className={`relative px-5 py-2 rounded-xl text-sm sm:text-base font-semibold transition-all border ${
                    activeTab === tab.id
                      ? 'bg-[#eaf580] border-[#b2cc68] text-[#436d33] shadow-md'
                      : 'bg-white/70 border-transparent text-gray-600 hover:bg-white'
                  }`}
                  type="button"
                >
                  {tab.label}
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 z-30 flex items-center gap-3">
              <button
                type="button"
                className={`${arrowButtonClasses} swiper-button-prev-blog`}
                aria-label="Önceki"
              >
              ...
              <button
                type="button"
                className={`${arrowButtonClasses} swiper-button-next-blog`}
                aria-label="Sonraki"
              >
                <ArrowIcon />
              </button>
